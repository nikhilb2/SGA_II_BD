...
<html>
	<head>
		<meta charset="UTF-8" />
		<title>
			${Writer.id == null ? 'Add New Writer' : 'Edit Writer'} - Library
			Management System
		</title>
		<link
			rel="stylesheet"
	...
	<body>
		...
		<div class="container mt-4">
			<div class="row mb-4">
				<div class="col-md-8">
					<h1>${Writer.id == null ? 'Add New Writer' : 'Edit Writer'}</h1>
					<p>
						${Writer.id == null ? 'Create a new Writer in your library.' :
						...
						<c:choose>
							<c:when test="${Writer.id == null}">
								...
								>
									...
									<a href="/Writers" class="btn btn-secondary">Cancel</a>
								</form:form>
							</c:when>
							<c:otherwise>
								<form:form
									method="POST"
									action="/Writers/update/${Writer.id}"
									modelAttribute="Writer"
								>
									<form:hidden path="id" />
