...
<html>
	<head>
		<meta charset="UTF-8" />
		<title>
			${book.id == null ? 'Add New Book' : 'Edit Book'} - Library Management
			System
		</title>
		<link
			rel="stylesheet"
		...
		<div class="container mt-4">
			<div class="row mb-4">
				<div class="col-md-8">
					...
					<p>
						${book.id == null ? 'Add a new book to your library.' : 'Update book
						information.'}
					</p>
				</div>
								...
								<form:form method="POST" action="/books" modelAttribute="book">
									...
									<div class="form-group">
										...
										<form:select
											...
											id="WriterId"
										>
											<form:option value="" label="-- Select Writer --" />
										...
										<form:errors path="WriterId" cssClass="error" />
									</div>
